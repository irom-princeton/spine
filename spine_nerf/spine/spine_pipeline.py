...
class SPINEPipelineConfig(VanillaPipelineConfig):
    ...
    datamanager: Union[SPINEDataManagerConfig] = field(default_factory=SPINEDataManagerConfig)
    """specifies the datamanager config"""
    model: Union[SPINEModelConfig] = field(default_factory=SPINEModelConfig())
